...
${BASE_PATH}/jhbuild-install/bin/jhbuild -f ${BASE_PATH}/epiphany-jhbuildrc run gdb -ex 'handle SIG33 pass nostop noprint' -ex 'set pagination 0'  -ex 'set args --enable-plugins=false' $@ ${BASE_PATH}/epiphany-install/bin/MiniBrowser
